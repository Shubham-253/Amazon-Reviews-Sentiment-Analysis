...
# LIVE HERE: https://sento-amazon.herokuapp.com/
...
streamlit run app.py
    ...
    <clipboard-copy aria-label="Copy" class="ClipboardButton btn js-clipboard-copy m-2 p-0 tooltipped-no-delay" data-copy-feedback="Copied!" data-tooltip-direction="w" value="python -m venv venv
venv/Scripts/activate
pip install -r requirements.txt
streamlit run app.py
